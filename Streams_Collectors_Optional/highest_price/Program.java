import java.util.List;
    ...
    public class Program {
        public static void main(String[] args) {
            ...
            System.out.println(String.format("%s", highestProduct1).replace(".", ","));
            System.out.println(String.format("%s", highestProduct2).replace(".", ","));
            System.out.println(String.format("%s", highestProduct3).replace(".", ","));
        }
    }