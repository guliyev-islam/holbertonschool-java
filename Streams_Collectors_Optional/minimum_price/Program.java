import java.util.List;
    ...
    public class Program {
        public static void main(String[] args) {
            ...
            System.out.println(String.format("%s", minimumProducts1).replace(".", ","));
            System.out.println(String.format("%s", minimumProducts2).replace(".", ","));
            System.out.println(String.format("%s", minimumProducts3).replace(".", ","));
        }
    }