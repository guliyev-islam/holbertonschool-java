import java.util.List;
    ...
    public class Program {
        public static void main(String[] args) {
            ...
            System.out.println(String.format("%s", orderProducts1).replace(".", ","));
            System.out.println(String.format("%s", orderProducts2).replace(".", ","));
            System.out.println(String.format("%s", orderProducts3).replace(".", ","));
            System.out.println(String.format("%s", orderProducts4).replace(".", ","));
        }
    }
