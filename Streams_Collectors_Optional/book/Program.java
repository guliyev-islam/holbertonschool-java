 import java.util.List;
    ...
    public class Program {
        public static void main(String[] args) {
            ...
            System.out.println(String.format("%s", bookProducts1).replace(".", ","));
            System.out.println(String.format("%s", bookProducts2).replace(".", ","));
            System.out.println(String.format("%s", bookProducts3).replace(".", ","));
        }
    }