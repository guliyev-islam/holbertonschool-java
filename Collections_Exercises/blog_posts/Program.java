import java.util.*;
    ...
    public class Program {
        public static void main(String[] args) throws Exception {
            ...
            System.out.println("[Azure Service Bus Where to Start, Publicando pipelines GitLab, TDD Made Simple]");      

            HashMap<Categories, TreeSet<Post>> postsByCategories = blog1.getAllPostsByCategories();

            System.out.println(postsByCategories);

            TreeMap<Author, TreeSet<Post>> postsByAuthor = blog1.getAllPostsByAuthor();
