...
public class Program {
	public static void main(String[] args) {
		...
		System.out.println();
 		System.out.println("{Product Owner=[listening to music, playing soccer, walking, watching series, watching soccer, watching movies], Analyst QA=[listening to music, walking, watching series], Developer=[listening to music, walking, watching series, watching soccer]}");
